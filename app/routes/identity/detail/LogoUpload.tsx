...
import DrawScreen from "../../ai-branding/create/image/Screen.js";

export default function LogoUpload(): JSX.Element {
  ...
  return useObserver(() => (
    <>
      ...
      >
        <Typography>
          지금까지 입력한 내용과 업로드한 이미지를 반영하여 로고를 생성해드려요.
        </Typography>
