...
export default function ApplyVenture(): JSX.Element {
  ...
  React.useEffect(() => {
    engineDataStore.setBrandingType("sketch");
  ...
  return useObserver(() => (
    <>
      ...
      >
        <Grid
          container
          direction={commonStore.isDesktop ? "row" : "row-reverse"}
        >
              ...
              >
                ...
                >
                  ...
                  <Grid container spacing={3}>
                                    ...
                                    label={
                                      <>
                                        <Typography fontSize={12}>
                                          RGB:{" "}
                                          {
                                            engineDataStore.brandInfo.color.main
                                              .rgb
                                          }
                                        </Typography>
                                      </>
                                    ...
                                    label={
                                      <>
                                        <Typography fontSize={12}>
                                          RGB:{" "}
                                          {
                                            engineDataStore.brandInfo.color.sub
                                              .rgb
                                          }
                                        </Typography>
                                      </>
                    ...
                    <Grid item xs={12}>
                      {!engineDataStore.logoInfo.sample &&
                      engineDataStore.logoInfo.result.result.predictions
                        .length > 0 ? (
                        <>
                          <Typography
                            fontWeight="bold"
                          ...
                          >
                            <Grid container spacing={1} sx={{}}>
                              {engineDataStore.logoInfo.result.result.predictions.map(
                                (w, j) => {
                                  return (
                                    <Grid
                                      key={j}
                                    ...
                                    >
                                      <Card
                                        sx={{
                                          border:
                                            engineDataStore.brandInfo.logo === w
                                              ? "2px solid #8265ff"
                        ...
                        >
                          {engineDataStore.brandIdentity.slogan.map((v, i) =>
                            v.result.predictions.map((w, j) => {
                              ...
                              return (
                                <MenuItem key={j} value={JSON.stringify(value)}>
                                  {w}
                                </MenuItem>
                              );
                            }),
                    ...
                    <Grid item xs={commonStore.isDesktop ? 6 : 12}>
                      ...
                      >
                        ...
                        >
                          {engineDataStore.brandIdentity.coreValue.map((v, i) =>
                            v.result.predictions.map((w, j) => {
                              const value = {
                                coreValue: w,
