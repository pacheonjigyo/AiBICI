...
export default function Preview(props: any): JSX.Element {
  ...
  return useObserver(() => (
    <Modal open={engineStore.isPreview}>
      <Paper
        sx={{
          background: "#333333",
        }}
      >
        ...
        >
          <Swiper
            ...
            spaceBetween={1000}
          >
            {engineDataStore.brandInfo.identity === "브랜드" ? (
              <>
                <SwiperSlide
                  style={{
          ...
          >
            <Button
              ...
              onClick={() => {
                engineStore.setPreview(false);
              }}
            >
              {commonStore.appInfo.language === "ko" ? "뒤로가기" : "Back"}
            </Button>
          </Box>
        </Box>
      </Paper>
